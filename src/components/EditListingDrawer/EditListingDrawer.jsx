...
function EditListingDrawer(props) {
    const { listingData } = props
    const resourceType = listingData.type
    ...
    const [dropdownOption, setDropdownOption] = useState(
        resourceType === 'desk' ? 'Desk'
            : resourceType === 'meeting_room' ? 'Meeting Room' :
                'Private Office'
    )
    ...
    const [selectedAmeneities, setSelectedAmeneitites] = useState(listingData.amenities)
    ...
    const setImages = () => {
        if (listingData.images.length === 1) {
            setListingImage1(listingData.images[0])
        }
        else if (listingData.images.length === 2) {
            setListingImage1(listingData.images[0])
            setListingImage2(listingData.images[1])
        } else {
            setListingImage1(listingData.images[0])
            setListingImage2(listingData.images[1])
            setListingImage3(listingData.images[2])
        }
    }
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            let type = ''
            if (dropdownOption === "Private Office") type = 'private_office'
            else if (dropdownOption === "Desk") type = 'desk'
            else if (dropdownOption === "Meeting Room") type = 'meeting_room'
            else alert('Invalid value selected')
            ...
            if (listingImage1 instanceof File && listingImage1 !== null) {
                formData.append('resourceImages', listingImage1);
            }
            else if (listingImage2 instanceof File && listingImage2 !== null) {
                formData.append('resourceImages', listingImage2);
            }
            else if (listingImage3 instanceof File && listingImage3 !== null) {
                formData.append('resourceImages', listingImage3);
            }
            privateRequest.put(`/resource/${listingData._id}`, formData, {
                headers: {
                    ...
                    ? (
                        <>
                            ...
                            <label htmlFor="image1">
                                ...
                                >
                                    <img
                                        src={listingImage1 instanceof File ? URL.createObjectURL(listingImage1) : listingImage1}
                                        alt="Company Logo"
                                        style={{
                                            borderRadius: '8px',
                                            width: '342px',
                        ...
                        ? (
                            <>
                                ...
                                <label htmlFor="image3">
                                    ...
                                    >
                                        <img
                                            src={listingImage2 instanceof File ? URL.createObjectURL(listingImage2) : listingImage2}
                                            alt="Company Logo"
                                            style={{
                                                borderRadius: '8px',
                                                width: '342px',
                    ...
                    ? (
                        <>
                            ...
                            <label htmlFor="icon-button-file">
                                ...
                                >
                                    <img
                                        src={listingImage3 instanceof File ? URL.createObjectURL(listingImage3) : listingImage3}
                                        alt="Company Logo"
                                        style={{
                                            borderRadius: '8px',
                                            width: '342px',
...
export default EditListingDrawer