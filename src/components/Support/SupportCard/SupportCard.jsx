            ...
            <Grid container sx={{ padding: '0px 42px' }}>
                ...
                <Grid item xs={3.3}>
                    <Box sx={{ width: '100%', display: 'flex' }}>
                        <Box sx={{ mr: '23px', mt: '16px' }}>
                            <img src={ticketDetails.createdBy[0].profilePicture} alt="Profile" style={{
                                width: '64px',
                                height: '64px',
                        ...
                        <Box >
                            <Typography sx={{ fontWeight: '500', fontSize: '18px', lineHeight: '24px', color: '#444344', mt: '22px' }}>
                                {ticketDetails.createdBy[0].firstName.en} {ticketDetails.createdBy[0].lastName.en}
                            </Typography>
                            <Typography sx={{ fontWeight: '500', fontSize: '14px', lineHeight: '24px', color: '#444344', mt: '4px' }}>
                                {ticketDetails.createdByCompany[0]?.name}
                            </Typography>
                        </Box>
